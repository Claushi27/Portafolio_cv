...
const translations = {
    es: {
        ...
        // Projects Section
        'proyectos-main': 'Últimos 4 Proyectos',
        ...
        'fletes-titulo': 'Sistema de Gestión de Fletes Marítimos',
        'fletes-desc': 'Aplicación web/móvil desarrollada con Flutter + Firebase para gestión completa de fletes marítimos. Incluye tracking en tiempo real, sistema de ratings, perfiles públicos, autenticación y diseño mobile-first responsive. CI/CD automatizado con GitHub Actions y deploy en Firebase Hosting.',
        'fletes-maritimos': 'Fletes Marítimos',
        'ferremas-titulo': 'FERREMAS - E-commerce Ferretería',
        'ferremas-desc': 'E-commerce académico completo para ferretería con React + TypeScript, Node.js, Supabase y pagos Webpay. Incluye catálogo de productos, carrito de compras, autenticación de usuarios y diseño responsive.',
        'dogstore-titulo': 'AWKA - E-commerce de Mascotas',
        'dogstore-desc': 'E-commerce completo con Firebase (Auth, Firestore, Storage), panel de administración para gestión de productos, carrito de compras funcional e integración con Mercado Pago. Incluye autenticación de usuarios y diseño responsive.',
    ...
    en: {
        ...
        // Projects Section
        'proyectos-main': 'Latest 4 Projects',
        ...
        'fletes-titulo': 'Maritime Freight Management System',
        'fletes-desc': 'Web/mobile application developed with Flutter + Firebase for complete maritime freight management. Includes real-time tracking, rating system, public profiles, authentication and mobile-first responsive design. Automated CI/CD with GitHub Actions and Firebase Hosting deployment.',
        'fletes-maritimos': 'Maritime Freight',
        'ferremas-titulo': 'FERREMAS - Hardware Store E-commerce',
        'ferremas-desc': 'Complete academic e-commerce for hardware store with React + TypeScript, Node.js, Supabase and Webpay payments. Includes product catalog, shopping cart, user authentication and responsive design.',
        'dogstore-titulo': 'AWKA - Pet Store E-commerce',
        'dogstore-desc': 'Complete e-commerce with Firebase (Auth, Firestore, Storage), admin panel for product management, functional shopping cart and Mercado Pago integration. Includes user authentication and responsive design.',
